...
class PhysicsInformedNN:
    ...
    def __init__(self, X, u, layers, lb, ub):
        ...
        self.loss = self.a*tf.reduce_mean(tf.square(self.u_tf - self.u_pred)) + \
                    self.b*tf.reduce_mean(tf.square(self.f_pred))
...
if __name__ == "__main__": 
    ...
    print('error_lambda_1_table_1'+str(error_lambda_1_table_1))
    print('error_lambda_2_table_1' + str(error_lambda_2_table_1))
    print('error_lambda_1_table_2'+str(error_lambda_1_table_2))
    print('error_lambda_2_table_2' + str(error_lambda_2_table_2))
