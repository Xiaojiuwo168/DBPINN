...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y, t, u, v, layers):
        ...
        self.layers = layers
        self.a = np.random.uniform(0.8,1.3)
        self.b = np.random.uniform(0.8,1.3)
        self.c = np.random.uniform(0.8,1.3)
        ...
        self.loss = 0
        self.loss = self.loss + self.a*(tf.reduce_sum(tf.square(self.u_tf - self.u_pred))) + \
                    self.b*(tf.reduce_sum(tf.square(self.v_tf - self.v_pred))) + \
                    self.c*(tf.reduce_sum(tf.square(self.f_u_pred)) + \
...
if __name__ == "__main__": 
    ...
    ans_u.append(error_u)
    ans_v.append(error_v)
    ans_p.append(error_p)
