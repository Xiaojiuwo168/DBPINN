...
if __name__ == "__main__": 
    ...
    lambda_1.append(error_lambda_1)
    lambda_2.append(error_lambda_2)
    # print('the average of 5 test lambda_1: %.5f%% ' % (sum(lambda_1) / iter))
    # print('the average of 5 test lambda_2: %.5f%% ' % (sum(lambda_2) / iter))
    ...
    lambda_1_noise.append(error_lambda_1_noisy)
    lambda_2_noise.append(error_lambda_2_noisy)
