...
class PhysicsInformedNN:
    ...
    def __init__(self, x0, u0, x1, layers, dt, lb, ub, q):
        ...
        self.loss = self.a*tf.reduce_sum(tf.square(self.u0_tf - self.U0_pred)) + \
                    self.b*tf.reduce_sum(tf.square(self.U1_pred[0,:] - self.U1_pred[1,:])) + \
                    self.c*tf.reduce_sum(tf.square(self.U1_x_pred[0,:] - self.U1_x_pred[1,:]))
